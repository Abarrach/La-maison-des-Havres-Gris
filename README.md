...
- **Inscription Discord épice** : poste `base_avancee` « Équipe Base avancée — Génie et appui lourd ». L’encart et la description du choix précisent : **1 constructeur/pilote avec sous-fief disponible + 1 pilote ; 2 buggys roquette à fournir**. Ce poste commun recueille les volontaires, l’organisateur distribue les deux fonctions sur le site. Les autres activités restent inchangées.
...
- **Préparation** : signalements du sous-fief non confirmé, du chef de base manquant, de patrouilleurs absents/dupliqués et des groupes incomplets ou incohérents. Une compo en cours peut être sauvegardée. Les anciennes compositions n’appliquent pas rétroactivement ces exigences ; une nouvelle sauvegarde inscrit `tactical_version: 2`.
