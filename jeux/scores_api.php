...
// Lu depuis le catalogue partagé — `define` et non `const` : une constante de
// classe ne peut pas être initialisée par un require.
define('GAMES', require __DIR__ . '/games_catalog.php');
